<script lang="ts">
  ...
  let { class: className = "", style = "fill-rule: evenodd; clip-rule: evenodd; fill: #635bff;" }: Props = $props();
</script>
...
>
  <g>
    ...
    ></path> <polygon {style} points="223.8,61.7 248.9,56.3 248.9,36 223.8,41.3 	"></polygon>
    <rect x="223.8" y="69.3" {style} width="25.1" height="87.5"></rect>
    <path
      {style}
