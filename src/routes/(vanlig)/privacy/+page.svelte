...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
  ...
  <p class="text-center">Last updated: {defaultConfig.privacy.lastUpdated}</p>
  ...
  <ul class="list-disc pl-8">
    ...
    <li>
      <strong>Association</strong> (referred to as either "the Association", "We", "Us" or "Our" in this Agreement) refers
      to Blålange, Traraveien 51.
    </li>
    <li>
    ...
    <li>
      <strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of the Association.
      It refers to third-party companies or individuals employed by the Association to facilitate the Service, to provide
      the Service on behalf of the Association, to perform services related to the Service or to assist the Association in
    ...
    <li>
      <strong>Website</strong> refers to blålange.org, accessible from https://blålange.org
    </li>
    <li>
      <strong>You</strong> means the individual accessing or using the Service, or the Association, or other legal entity
  ...
  <p>We may collect, but not limited to:</p>
  <ul class="list-disc pl-8">
    <li>IP address</li>
    <li>Useragent</li>
  ...
  <p>The Association may use Personal Data for the following purposes:</p>
  <ul class="list-disc pl-8">
    <li>
    ...
    <li>
      <strong>To contact You:</strong> To contact You by email or other equivalent forms of electronic communication, such
    ...
    <li>
      ...
      which we offer that are similar to those that you have already purchased or enquired about unless You have opted not
    ...
    <li>
      ...
      usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products,
  ...
  <ul class="list-disc pl-8">
    ...
    <li>
      ...
      during negotiations of, any merger, sale of Association assets, financing, or acquisition of all or a portion of Our
      business to another Association.
    </li>
    <li>
      <strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will require
      those affiliates to honor this Privacy Policy. Affiliates include Our parent Association and any other subsidiaries,
  ...
  <p>The Association may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
  <ul class="list-disc pl-8">
    <li>Comply with a legal obligation</li>
    <li>Protect and defend the rights or property of the Association</li>
  ...
  <ul class="list-disc pl-8">
    <li>
      <p>By email: <a href="mailto:{defaultConfig.emails.privacyAgent}">{defaultConfig.emails.privacyAgent}</a></p>
    </li>
  </ul>
</div>
