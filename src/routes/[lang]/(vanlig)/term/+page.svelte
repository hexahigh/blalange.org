...
<script lang="ts">
  ...
  let commands: CommandsType = [
    ...
    },
    {
      ...
      hidden: false,
      execute: async () => {
        const module = await import("./commands/fetch.js.js");
    ...
    },
    {
      ...
      execute: async (args) => {
        showInput = false;
        const module = await import("./commands/httping.js.js");
    ...
    },
    {
      ...
      hidden: false,
      execute: async (args) => {
        const module = await import("./commands/joke.js.js");
    ...
    },
    {
      ...
      hidden: false,
      execute: async (args) => {
        const module = await import("./commands/prime.js.js");
    ...
    },
    {
      ...
      hidden: false,
      execute: async (args) => {
        const module = await import("./commands/apple.js.js");
    ...
    },
    {
      ...
      hidden: false,
      execute: async (args) => {
        const module = await import("./commands/apple-hd.js.js");
    ...
    },
    {
      ...
      hidden: false,
      execute: async (args) => {
        const module = await import("./commands/pootis.js.js");
    ...
    },
    {
      ...
      hidden: false,
      execute: async (args) => {
        const module = await import("./commands/beast.js.js");
